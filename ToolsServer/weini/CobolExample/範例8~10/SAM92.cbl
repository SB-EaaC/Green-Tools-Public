      ** 程式範例九-2 (SAM92.CBL)
      ** 雙層控制中斷(Control Break)

        IDENTIFICATION  DIVISION.
        PROGRAM-ID.     Sample9-2.
      **
        ...
        FILE-CONTROL.
           ...
           SELECT OUT-FILE ASSIGN TO RANDOM "SAMPLE92.OUT"
                  ORGANIZATION IS LINE SEQUENTIAL.
      **
        DATA    DIVISION.
        FILE    SECTION.
        ...
        01 DAY-LINE.
           05 FILLER            PIC X(10).
           05 D-SALES-YEAR      PIC 99/.
           05 D-SALES-MONTH     PIC 99/.
           05 D-SALES-DAY       PIC 99.
           05 FILLER            PIC X(19) VALUE "日銷售數量....     ".
           05 D-DAY-TOTAL       PIC ZZ,ZZ9.
        ...
        77 CHECK-DAY    PIC 9(2).
        77 DAY-TOTAL    PIC 9(8).
      ...
      **
        ...
        400-LOOP-RTN.
            ...
            END-IF.
            IF SALES-DAY NOT = CHECK-DAY
               PERFORM 480-PROCESS-DAY-RTN
            END-IF.
        ...
        450-PROCESS-MONTH-RTN.
            ...
            WRITE OUT-REC FROM MONTH-LINE AFTER 2 LINES.
            MOVE SALES-MONTH TO CHECK-MONTH.
            MOVE ZEROS TO MONTH-TOTAL.
        480-PROCESS-DAY-RTN.
            MOVE CHECK-YEAR TO D-SALES-YEAR.
            MOVE CHECK-MONTH TO D-SALES-MONTH.
            MOVE CHECK-DAY TO D-SALES-DAY,
            MOVE DAY-TOTAL TO D-DAY-TOTAL.
            WRITE OUT-REC FROM DAY-LINE AFTER 2 LINES.
            MOVE SALES-DAY TO CHECK-DAY.
            MOVE ZEROS TO DAY-TOTAL.
        500-WRITE-ENDING.
            PERFORM 450-PROCESS-MONTH-RTN.
