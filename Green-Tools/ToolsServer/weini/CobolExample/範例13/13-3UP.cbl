      ** 13-3UP.CBL : SAM13-3.CBL CALL 更改資料副程式

        IDENTIFICATION  DIVISION.
        PROGRAM-ID.     13-3-UPDATE-SUB.
      **
      ...
      **
        ...
        LINKAGE         SECTION.
        01 UPDATE-NO    PIC X(5).
        01 UPDATE-NAME  PIC X(10).
        01 UPDATE-QTY   PIC 9(3).
      **
       PROCEDURE       DIVISION USING UPDATE-NO UPDATE-NAME UPDATE-QTY.
       000-MAIN-RTN.
       ...
       320-REWRITE.
           ...
           IF SURE = "Y"
              MOVE PRO-NO   TO UPDATE-NO
              MOVE PRO-NAME TO UPDATE-NAME
              MOVE PRO-QTY  TO UPDATE-QTY
